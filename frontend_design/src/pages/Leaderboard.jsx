...
import { leaders, categories } from '@/mock';
...
const AVATAR_SIZE = { 1: 112, 2: 84, 3: 72 };
const MIN_HEIGHT = { 1: 'min-h-[260px]', 2: 'min-h-[210px]', 3: 'min-h-[190px]' };
...
export default function Leaderboard() {
  ...
  const [top1, top2, top3] = podiumData;
