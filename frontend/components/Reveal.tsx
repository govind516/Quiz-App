...
export function RevealHeading({ lines, className = "", delay = 0 }: { lines: string[]; className?: string; delay?: number }) {
...
export function FadeUp({ children, delay = 0, y = 24, className = "" }: { children: React.ReactNode; delay?: number; y?: number; className?: string }) {
  const reduce = useReducedMotion();
  return (
    <motion.div
